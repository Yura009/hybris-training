...
<div class="container">
    ...
    <div>
        ...
        <ul>
            <li><strong>resources/trainingextension-items.xml</strong> - here you can model your items</li>
            <li><strong>resources/trainingextension-spring.xml</strong> - here you can define your services</li>
            <li><strong>web/webroot/WEB-INF/config/trainingextension-spring-mvc-config.xml</strong> - here is a Spring MVC related
                configuration
            </li>
            <li><strong>web/webroot/WEB-INF/config/trainingextension-web-app-config.xml</strong> - here you can define web related services,
                facades etc.
            </li>
            <li><strong>web/webroot/WEB-INF/config/trainingextension-spring-security-config.xml</strong> - here you can configure your Spring Security settings</li>
